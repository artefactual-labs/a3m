...
from a3m.server.mcp import watched_dir_handler
...
def test_watched_dir_handler_creates_transfer_if_it_does_not_exist(mocker, tmpdir):
    ...
    mocker.patch("a3m.server.mcp.JobChain", job_chain_mock)
    ...
    mocker.patch("a3m.server.packages.uuid4", return_value=transfer_uuid)
    ...
    create_mock = mocker.patch(
        "a3m.server.packages.models.Transfer.objects.create", return_value=transfer_mock
    )
