...
class ProcessingConfig(google.protobuf.message.Message):
    ...
    class _AIPCompressionAlgorithmEnumTypeWrapper(
        ...
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        AIP_COMPRESSION_ALGORITHM_UNSPECIFIED: (
            ProcessingConfig._AIPCompressionAlgorithm.ValueType
        )  # 0
        AIP_COMPRESSION_ALGORITHM_UNCOMPRESSED: (
            ProcessingConfig._AIPCompressionAlgorithm.ValueType
        )  # 1
        """It breaks in verify_aip."""
        AIP_COMPRESSION_ALGORITHM_TAR: (
            ProcessingConfig._AIPCompressionAlgorithm.ValueType
        )  # 2
        """Not supported yet!"""
        AIP_COMPRESSION_ALGORITHM_TAR_BZIP2: (
            ProcessingConfig._AIPCompressionAlgorithm.ValueType
        )  # 3
        AIP_COMPRESSION_ALGORITHM_TAR_GZIP: (
            ProcessingConfig._AIPCompressionAlgorithm.ValueType
        )  # 4
        AIP_COMPRESSION_ALGORITHM_S7_COPY: (
            ProcessingConfig._AIPCompressionAlgorithm.ValueType
        )  # 5
        AIP_COMPRESSION_ALGORITHM_S7_BZIP2: (
            ProcessingConfig._AIPCompressionAlgorithm.ValueType
        )  # 6
        AIP_COMPRESSION_ALGORITHM_S7_LZMA: (
            ProcessingConfig._AIPCompressionAlgorithm.ValueType
        )  # 7
    ...
    AIP_COMPRESSION_ALGORITHM_UNSPECIFIED: (
        ProcessingConfig.AIPCompressionAlgorithm.ValueType
    )  # 0
    AIP_COMPRESSION_ALGORITHM_UNCOMPRESSED: (
        ProcessingConfig.AIPCompressionAlgorithm.ValueType
    )  # 1
    ...
    aip_compression_algorithm: (
        global___ProcessingConfig.AIPCompressionAlgorithm.ValueType
    )
